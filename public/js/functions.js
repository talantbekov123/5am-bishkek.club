var INSPIRO = {}, $ = jQuery.noConflict(); (function ($) {
        ...
        functions: function () {
            ...
            if ($equalize.length > 0) {
                $equalize.each(function () {
                    var elem = $(this), selectorItem = elem.find(elem.attr("data-equalize-item")) || "> div", maxHeight = 0
            ...
            if ($customHeight.length > 0) {
                $customHeight.each(function () {
                    var elem = $(this), elemHeight = elem.attr("data-height") || 400, elemHeightLg = elem.attr("data-height-lg") || elemHeight, elemHeightMd = elem.attr("data-height-md") || elemHeightLg, elemHeightSm = elem.attr("data-height-sm") || elemHeightMd, elemHeightXs = elem.attr("data-height-xs") || elemHeightSm
                    function customHeightBreakpoint(setHeight) {
                        if (setHeight) { elem = setHeight }
                        switch ($(window).breakpoints("getBreakpoint")) {
                            case "xs": elem.height(elemHeightXs)
                                break
    ...
    INSPIRO.header = {
        functions: function () { INSPIRO.header.logoStatus(); INSPIRO.header.stickyHeader(); INSPIRO.header.topBar(); INSPIRO.header.search(); INSPIRO.header.mainMenu(); INSPIRO.header.mainMenuOverlay(); INSPIRO.header.pageMenu(); INSPIRO.header.sidebarOverlay(); INSPIRO.header.dotsMenu(); INSPIRO.header.onepageMenu() }, logoStatus: function (status) {
            var headerLogoDefault = headerLogo.find($(".logo-default")), headerLogoDark = headerLogo.find($(".logo-dark")), headerLogoFixed = headerLogo.find(".logo-fixed"), headerLogoResponsive = headerLogo.find(".logo-responsive");
            ...
            $(window).breakpoints("greaterEqualTo", "lg", function () {
                if (!$header.is(".header-disable-fixed")) {
                    if (scrollOnTop > $headerOffsetTop + shrinkHeader) {
                        $header.addClass("header-sticky"); if (scrollOnTop > $headerOffsetTop + shrinkHeaderActive) {
                            $header.addClass("sticky-active"); if (Settings.submenuLight && Settings.headerHasDarkClass) { $header.removeClass("dark"); Settings.headerDarkClassRemoved = !0 }
                            // custom js
                            document.getElementById("axilary-header").style.visibility = "visible";
                            INSPIRO.header.logoStatus()
                        }
                    } else {
                        // custom js
                        document.getElementById("axilary-header").style.visibility = "hidden";
                        $header.removeClass().addClass($headerCurrentClasses); if (Settings.sliderDarkClass && Settings.headerHasDarkClass) { $header.removeClass("dark"); Settings.headerDarkClassRemoved = !0 }
                        INSPIRO.header.logoStatus()
                    }
                }
            }); $(window).breakpoints("lessThan", "lg", function () {
                if ($header.attr("data-responsive-fixed") == "true") {
                    if (scrollOnTop > $headerOffsetTop + shrinkHeader) {
                        $header.addClass("header-sticky"); if (scrollOnTop > $headerOffsetTop + shrinkHeaderActive) {
                            $header.addClass("sticky-active"); if (Settings.submenuLight) {
                        ...
                        $header.removeClass().addClass($headerCurrentClasses); if (Settings.headerDarkClassRemoved == !0 && $body.hasClass("mainMenu-open")) { $header.removeClass("dark") }
                        INSPIRO.header.logoStatus()
                    }
                }
            })
            ...
            if ($mainMenu.length > 0) {
                $mainMenu.find(".dropdown, .dropdown-submenu").prepend('<span class="dropdown-arrow"></span>'); var $menuItemLinks = $('#mainMenu nav > ul > li.dropdown > a[href="#"], #mainMenu nav > ul > li.dropdown > .dropdown-arrow, .dropdown-submenu > a[href="#"], .dropdown-submenu > .dropdown-arrow, .dropdown-submenu > span, .page-menu nav > ul > li.dropdown > a'), $triggerButton = $("#mainMenu-trigger a, #mainMenu-trigger button"), processing = !1, triggerEvent; $triggerButton.on("click", function (e) {
                    var elem = $(this); e.preventDefault(); $(window).breakpoints("lessThan", "lg", function () {
                        var openMenu = function () {
                            if (!processing) {
                                processing = !0; Settings.menuIsOpen = !0; if (Settings.submenuLight && Settings.headerHasDarkClass) { $header.removeClass("dark"); Settings.headerDarkClassRemoved = !0 } else { if (Settings.headerHasDarkClass && Settings.headerDarkClassRemoved) { $header.addClass("dark") } }
                        ...
                        var closeMenu = function () {
                            if (!processing) {
                                processing = !0; Settings.menuIsOpen = !1; INSPIRO.header.logoStatus(); $mainMenu.animate({ "min-height": 0 }, {
                                    start: function () { $mainMenu.removeClass("menu-animate") }, done: function () {
                                        $body.removeClass("mainMenu-open"); elem.removeClass("toggle-active"); if (Settings.submenuLight && Settings.headerHasDarkClass && Settings.headerDarkClassRemoved && !$header.hasClass("header-sticky")) { 
                                            $header.addClass("dark")
                                        }
                                        if (Settings.sliderDarkClass && Settings.headerHasDarkClass && Settings.headerDarkClassRemoved) { $header.removeClass("dark"); Settings.headerDarkClassRemoved = !0 }
                                    }, duration: 500, easing: "easeInOutQuart", complete: function () { processing = !1 }
                                })
                            }
                        }
            ...
            var $sidepanel = $("#sidepanel"), $sidepanelTrigger = $(".panel-trigger"), sidepanelProcessing = !1, sidepanelEvent; $sidepanelTrigger.on("click", function (e) {
                e.preventDefault(); var panelOpen = function () { if (!sidepanelProcessing) { sidepanelProcessing = !0; Settings.panelIsOpen = !0; $sidepanel.addClass("panel-open"); sidepanelProcessing = !1 } }
            ...
            var $dotsMenu = $("#dotsMenu"), $dotsMenuItems = $dotsMenu.find("ul > li > a"); if ($dotsMenu.length > 0) {
                $dotsMenuItems.on("click", function () { $dotsMenuItems.parent("li").removeClass("current"); $(this).parent("li").addClass("current"); return !1 })
                $dotsMenuItems.parents("li").removeClass("current"); $dotsMenu.find('a[href="#' + INSPIRO.header.currentSection() + '"]').parent("li").addClass("current")
            }
        }, onepageMenu: function () { if ($mainMenu.hasClass("menu-one-page")) { var $currentMenuItem = "current"; $(window).on("scroll", function () { var $currentSection = INSPIRO.header.currentSection(); $mainMenu.find("nav > ul > li > a").parents("li").removeClass($currentMenuItem); $mainMenu.find('nav > ul > li > a[href="#' + $currentSection + '"]').parent("li").addClass($currentMenuItem) }) } }, currentSection: function () {
    ...
    INSPIRO.slider = {
        functions: function () { INSPIRO.slider.inspiroSlider(); INSPIRO.slider.carousel() }, inspiroSlider: function () {
            if ($inspiroSlider.length > 0) {
                ...
                var defaultAnimation = "fadeInUp"; function animate_captions($elem) {
                    ...
                    $captions.each(function (index) {
                        var $captionElem = $(this), captionDelay = $captionElem.attr("data-caption-delay") || index * 350 + 1000, captionAnimation = $captionElem.attr("data-caption-animate") || defaultAnimation; var t = setTimeout(function () {
                ...
                function slide_dark(elem) {
                    var $sliderClassSlide = elem.find(".slide.is-selected"); if ($sliderClassSlide.hasClass("slide-dark") && Settings.headerHasDarkClass) { $header.removeClass("dark"); Settings.sliderDarkClass = !0; Settings.headerDarkClassRemoved = !0 } else {
                        Settings.sliderDarkClass = !1; if (Settings.headerDarkClassRemoved && Settings.headerHasDarkClass && !$body.hasClass("mainMenu-open") && !$header.hasClass("sticky-active")) {
                            $header.addClass("dark")
                        }
                    }
                }
                ...
                $inspiroSlider.each(function () {
                    ...
                    elem.find(".slide").each(function () {
                        if ($(this).hasClass("kenburns")) {
                            var elemChild = $(this), elemChildImage = elemChild.css("background-image").replace(/.*\s?url\([\'\"]?/, "").replace(/[\'\"]?\).*/, "")
            ...
            var elem = $(".carousel"); var $carouselAjax = $(elem).imagesLoaded(function () {
        ...
        functions: function () { INSPIRO.elements.shapeDivider(); INSPIRO.elements.naTo(); INSPIRO.elements.morphext(); INSPIRO.elements.buttons(); INSPIRO.elements.accordion(); INSPIRO.elements.animations(); INSPIRO.elements.parallax(); INSPIRO.elements.backgroundImage(); INSPIRO.elements.responsiveVideos(); INSPIRO.elements.countdownTimer(); INSPIRO.elements.progressBar(); INSPIRO.elements.pieChart(); INSPIRO.elements.maps(); INSPIRO.elements.gridLayout(); INSPIRO.elements.tooltip(); INSPIRO.elements.popover(); INSPIRO.elements.magnificPopup(); INSPIRO.elements.yTPlayer(); INSPIRO.elements.vimeoPlayer(); INSPIRO.elements.modal(); INSPIRO.elements.sidebarFixed(); INSPIRO.elements.clipboard(); INSPIRO.elements.bootstrapSwitch(); INSPIRO.elements.countdown(); INSPIRO.elements.other(); INSPIRO.elements.videoBackground(); INSPIRO.elements.forms(); INSPIRO.elements.formValidation(); INSPIRO.elements.formAjaxProcessing(); INSPIRO.elements.floatingDiv(); INSPIRO.elements.wizard(); INSPIRO.elements.counters() }, forms: function () {
            ...
            if ($ajaxForm.length > 0) {
                $ajaxForm.each(function () {
                    var elem = $(this), elemSuccessMessage = elem.attr("data-success-message") || "We have <strong>successfully</strong> received your Message and will get Back to you as soon as possible.", elemCustomRedirectPage = elem.attr("data-success-page"); var button = elem.find("button#form-submit"), buttonText = button.html()
            ...
            if ($(".btn-slide[data-width]")) {
                $(".btn.btn-slide[data-width]").each(function () {
                    ...
                    switch (!0) {
                        case elem.hasClass("btn-lg"): elemDefaultWidth = "60"
                            break
            ...
            var accordionType = "accordion", toogleType = "toggle", accordionItem = "ac-item", itemActive = "ac-active", itemTitle = "ac-title", itemContent = "ac-content", $accs = $("." + accordionItem)
            $accs.length && ($accs.each(function () {
                var $item = $(this)
                $item.hasClass(itemActive) ? $item.addClass(itemActive) : $item.find("." + itemContent).hide()
            }), $("." + itemTitle).on("click", function (e) {
                var $link = $(this), $item = $link.parents("." + accordionItem), $acc = $item.parents("." + accordionType)
            ...
            if ($parallax.length > 0) {
                ...
                $parallax.each(function () {
                    var $elem = $(this), elemImageSrc = $elem.attr("data-bg-parallax"), elemImageVelocity = $elem.attr("data-velocity") || "-.140"
            ...
            if ($counter.length > 0) {
                ...
                $counter.each(function () {
                    var elem = $(this), prefix = elem.find("span").attr("data-prefix") || "", suffix = elem.find("span").attr("data-suffix") || ""
                    setTimeout(function () {
                        new Waypoint({
                            element: elem, handler: function () {
            ...
            if ($countdownTimer.length > 0) {
                ...
                $(".countdown").each(function (index, element) { var elem = $(element), finalDate = elem.attr("data-countdown"); elem.countdown(finalDate, function (event) { elem.html(event.strftime('<div class="countdown-container"><div class="countdown-box"><div class="number">%-D</div><span>Days</span></div>' + '<div class="countdown-box"><div class="number">%H</div><span>Hours</span></div>' + '<div class="countdown-box"><div class="number">%M</div><span>Minutes</span></div>' + '<div class="countdown-box"><div class="number">%S</div><span>Seconds</span></div></div>')) }) })
            }
        }, progressBar: function () {
            var $progressBar = $(".p-progress-bar") || $(".progress-bar")
            if ($progressBar.length > 0) {
                $progressBar.each(function (i, elem) {
                    var $elem = $(this), percent = $elem.attr("data-percent") || "100", delay = $elem.attr("data-delay") || "60", type = $elem.attr("data-type") || "%"
            ...
            if ($gridLayout.length > 0) {
                ...
                $gridLayout.each(function () {
                    ...
                    elem.append('<div class="grid-loader"></div>'); var $isotopelayout = $(elem).imagesLoaded(function () {
                    ...
                    if ($gridFilter.length > 0) {
                        $gridFilter.each(function () {
                            var elemFilter = $(this), $filterItem = elemFilter.find("a"), elemFilterLayout = elemFilter.attr("data-layout"), $filterItemActiveClass = "active"
                            $filterItem.on("click", function () {
                                elemFilter.find("li").removeClass($filterItemActiveClass); $(this).parent("li").addClass($filterItemActiveClass); var filterValue = $(this).attr("data-category"); $(elemFilterLayout).isotope({ filter: filterValue }).on("layoutComplete", function () { $window.trigger("scroll"); INSPIRO.elements.naTo() })
            ...
            elem.on('append.infiniteScroll', function (event, response, path, items) { INSPIRO.slider.carousel($(items).find('.carousel')); loadMoreBtn.html(loadMoreBtnText); element.css("margin", "0 -" + gridMargin + "px -" + gridMargin + "px 0"); element.find('.' + gridItem).css("padding", "0 " + gridMargin + "px " + gridMargin + "px 0") })
        }, tooltip: function () {
            ...
            if ($lightbox.length > 0) {
                ...
                var getType = {
                    image: {
                        type: "image", closeOnContentClick: !0, removalDelay: 500, image: { verticalFit: !0 }, callbacks: {
                            beforeOpen: function () {
                        ...
                        delegate: 'a[data-lightbox="gallery-image"], a[data-lightbox="image"]', type: "image", image: { verticalFit: !0 }, gallery: { enabled: !0, navigateByImgClick: !0, preload: [0, 1] }, removalDelay: 500, callbacks: {
                            beforeOpen: function () {
                                this.st.image.markup = this.st.image.markup.replace("mfp-figure", "mfp-figure mfp-with-anim")
                                this.st.mainClass = "mfp-zoom-out"
                            }
                ...
                $lightbox.each(function () {
                    ...
                    switch (elemType) {
                        case "image": elem.magnificPopup(getType.image)
                            break
            ...
            if ($modal.length > 0) {
                $modal.each(function () {
                    var elem = $(this), elemDelay = elem.attr("data-delay") || 3000, elemCookieExpire = elem.attr("data-cookie-expire") || 365, elemCookieName = elem.attr("data-cookie-name") || "cookieModalName2020_3", elemCookieEnabled = elem.data("cookie-enabled") == !0 ? !0 : !1, elemModalDismissDelay = elem.attr("data-delay-dismiss")
                                    ...
                                    $.magnificPopup.open({
                                        items: { src: elem }, type: "inline", closeBtnInside: !0, callbacks: {
                                            beforeOpen: function () {
                                                this.st.image.markup = this.st.image.markup.replace("mfp-figure", "mfp-figure mfp-with-anim")
                                                this.st.mainClass = "mfp-zoom-out"
                                            }, open: function () { if (elem.find("video").length > 0) { elem.find("video").get(0).play() } }, close: function () { Cookies.set(elemCookieName, !0, { expires: Number(elemCookieExpire) }) }
                                        }
                                    }, 0)
                                }, elemDelay)
                            }
            ...
            if ($modalStrip.length > 0) {
                $modalStrip.each(function () {
                    var elem = $(this), elemDelay = elem.attr("data-delay") || 3000, elemCookieExpire = elem.attr("data-cookie-expire") || 365, elemCookieName = elem.attr("data-cookie-name") || "cookieName2013", elemCookieEnabled = elem.data("cookie-enabled") == !0 ? !0 : !1, elemModalDismissDelay = elem.attr("data-delay-dismiss")
                    if (elem.hasClass(modalShow)) {
                        var modalElem = $(this)
            ...
            var $element, $elementContainer, $animateEnter = $animateEnter || "fadeInDown", $animateExit = $animateExit || "fadeOutDown", $placement, $backgroundImage, $backgroundImageContainer, $timeout
            ...
            if ($clipboardTarget.length > 0) {
                ...
                function clipboardInit(clipboardType) {
                    clipboardType.each(function () {
                        var elem = $(this), title = elem.attr("data-original-title") || "Copy to clipboard", titleSuccess = elem.attr("data-original-title-success") || "Copied!"
            ...
            if ($countdown.length > 0) {
                $countdown.each(function () {
                    var $elem = $(this), $elemCount = $elem.find(".p-countdown-count"), $elemShow = $elem.find(".p-countdown-show"), $elemSeconds = $elem.attr("data-delay") || 5
        ...
        functions: function () {
            ...
            var $widget_instagram = $(".widget-instagram"); if ($widget_instagram.length > 0) {
                ...
                $widget_instagram.each(function () {
                    var elem = $(this), instagramLimit = elem.attr("data-limit") || 12, instagramColumns = elem.attr("data-col") || 3, instagramAccessToken = elem.attr("data-token") || "5783726529.226c7d2.68a168eec1264759b9f91c1fc2c6ce56", instagramItems = "#instagram-cnt", instagramSize = elem.attr("data-size") || "small", instagramGridColumns = "grid-" + instagramColumns
            ...
            if ($subscribeForm.length > 0) {
                $subscribeForm.each(function () {
                    var elem = $(this), elemSuccessMessage = elem.attr("success-message") || "You have successfully subscribed to our mailing list."
                    ...
                    elem.submit(function (event) {
                        ...
                        if (elem[0].checkValidity() === !1) {
                            ...
                            $.ajax({
                                url: post_url, type: request_method, data: form_data, dataType: "json", success: function (text) {
                                    if (text.response == "success") {
    ...
    $window.on("resize", function () { INSPIRO.header.logoStatus(); INSPIRO.header.stickyHeader() })
})(jQuery)